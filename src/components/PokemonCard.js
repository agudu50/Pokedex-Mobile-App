...
export default function PokemonCard({
  ...
  // Local state fallback in case props are managed locally or via context
  ...
  // Resolve image: use passed image prop, or fallback to mapped asset
  const imageSource = image || getPokemonImage(number, name);
  ...
  return (
    ...
    >
      <View style={styles.cardInner}>
        ...
        {/* Right Side: Colored Element Background, Image, Favorite Icon */}
        <View style={[styles.imageWrapper, { backgroundColor: typeConfig.containerColor }]}>
          {/* Subtle background element shape effect */}
