  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            <View style={styles.rowLeft}>
              ...
              <Text style={styles.rowLabel}>Sistema Métrico (m / kg)</Text>
            </View>
            <Switch
              value={metricUnits}
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Dados & Cache</Text>
          <TouchableOpacity
            style={styles.actionRow}
            onPress={() => Alert.alert('Cache Limpo', 'O cache de imagens e dados da PokéAPI foi limpo.')}
          >
            <View style={styles.rowLeft}>
              <Ionicons name="trash-outline" size={22} color="#E11D48" />
              <Text style={[styles.rowLabel, { color: '#E11D48' }]}>Limpar Cache da PokéAPI</Text>
            </View>
